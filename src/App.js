    ...
    <div className="min-h-screen">
      ...
      <div className="relative z-10 p-4 flex flex-col min-h-screen">
        <header className="text-center mb-8 p-4 bg-white bg-opacity-40 rounded-lg backdrop-blur-sm">
          <h1 className="text-3xl font-bold text-indigo-900">L'évolution des droits accordés aux femmes de nationalité française du 20ème siècle jusqu'à nos jours</h1>
          <p className="text-gray-700 italic mt-2">Projet EMC 2025</p>
        </header>
...
const WorkPoster = () => (
  <div className="backdrop-blur-md bg-white bg-opacity-60 rounded-lg shadow-xl p-8 max-w-4xl">
    <div className="flex items-center mb-6">
      ...
      <h2 className="text-4xl font-bold text-indigo-900">Les femmes au travail</h2>
    </div>
    
    <div className="mb-10">
      <h3 className="text-2xl font-bold text-indigo-700 mb-4">Le plafond de verre</h3>
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 bg-white bg-opacity-70 p-4 rounded-lg">
          <p className="mb-3">Le "plafond de verre" désigne l'ensemble des barrières invisibles qui limitent l'ascension des femmes aux postes à haute responsabilité au sein des organisations.</p>
          <p>Malgré des qualifications égales, les femmes se heurtent à des obstacles qui freinent leur progression professionnelle.</p>
        </div>
        <div className="flex-1 bg-indigo-100 bg-opacity-80 rounded-lg p-4 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-indigo-800">Représentation des femmes aux postes de direction (1980-2020)</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="mb-10">
      <h3 className="text-2xl font-bold text-indigo-700 mb-4">L'indépendance financière</h3>
    ...
    <div>
      <h3 className="text-2xl font-bold text-indigo-700 mb-4">Les écarts salariaux</h3>
      <div className="flex flex-col md:flex-row gap-6 items-center">
        <div className="flex-1">
          <div className="bg-white bg-opacity-70 p-6 rounded-lg border-l-4 border-red-600">
            ...
            <p className="text-gray-700">Différence moyenne de salaire entre hommes et femmes en 1917</p>
          </div>
          <div className="bg-white bg-opacity-70 p-6 rounded-lg border-l-4 border-amber-600 mt-4">
            <p className="text-2xl font-bold text-amber-700">16,8%</p>
            <p className="text-gray-700">Différence moyenne de salaire entre hommes et femmes en 2020</p>
          </div>
        </div>
        <div className="flex-1 bg-white bg-opacity-70 p-4 rounded-lg">
          <p className="mb-3">Malgré des avancées significatives, les inégalités salariales persistent.</p>
          <p className="mb-3">À compétences égales et postes équivalents, les femmes sont encore moins rémunérées que les hommes.</p>
          <p>Le principe "à travail égal, salaire égal" reste un combat d'actualité.</p>
        </div>
      </div>
    </div>
  </div>
...
const PoliticalPoster = () => (
  <div className="backdrop-blur-md bg-white bg-opacity-60 rounded-lg shadow-xl p-8 max-w-4xl">
    <div className="flex items-center mb-6">
      ...
      <h2 className="text-4xl font-bold text-rose-900">Les femmes dans la vie politique</h2>
    </div>
    
    <div className="mb-10">
      <h3 className="text-2xl font-bold text-rose-700 mb-4">Le droit de vote</h3>
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 bg-white bg-opacity-70 p-4 rounded-lg">
          <p className="mb-3">Le 21 avril 1944, les femmes françaises obtiennent le droit de vote par une ordonnance du Gouvernement provisoire de la République française présidé par le général de Gaulle.</p>
          <p className="mb-3">Le 29 avril 1945, les Françaises votent pour la première fois lors des élections municipales.</p>
          <p>La France est l'un des derniers pays d'Europe occidentale à accorder le droit de vote aux femmes.</p>
        </div>
          ...
          <div className="text-center relative h-48 w-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-24 h-24 rounded-full border-4 border-rose-600 flex items-center justify-center bg-white bg-opacity-90">
                <div className="text-rose-800 font-bold">1944</div>
              </div>
            </div>
            <p className="absolute bottom-0 w-full text-sm text-rose-800">De l'exclusion à la participation citoyenne</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="mb-10">
      <h3 className="text-2xl font-bold text-rose-700 mb-4">L'IVG dans la Constitution</h3>
      <div className="bg-white bg-opacity-70 p-6 rounded-lg mb-4">
        <div className="flex items-start">
          <div className="flex-shrink-0">
            <div className="w-16 h-16 bg-rose-600 text-white rounded-full flex items-center justify-center font-bold text-lg">1975</div>
          </div>
          <div className="ml-4">
            <p className="font-bold text-lg">Loi Veil</p>
            <p className="text-gray-700">Dépénalisation de l'interruption volontaire de grossesse (IVG) pour une période de 5 ans, grâce au combat de Simone Veil.</p>
          </div>
        </div>
      </div>
      <div className="bg-white bg-opacity-70 p-6 rounded-lg">
        <div className="flex items-start">
          <div className="flex-shrink-0">
            <div className="w-16 h-16 bg-rose-700 text-white rounded-full flex items-center justify-center font-bold text-lg">2023</div>
          </div>
          <div className="ml-4">
            <p className="font-bold text-lg">Constitutionnalisation de l'IVG</p>
            <p className="text-gray-700">La France devient le premier pays au monde à inscrire explicitement le droit à l'avortement dans sa Constitution.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      <h3 className="text-2xl font-bold text-rose-700 mb-4">Représentation politique</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white bg-opacity-70 p-4 rounded-lg text-center">
          <p className="text-rose-800 text-3xl font-bold">1936</p>
          <p className="text-gray-700">Trois femmes sous-secrétaires d'État dans le gouvernement du Front populaire</p>
        </div>
        <div className="bg-white bg-opacity-70 p-4 rounded-lg text-center">
          <p className="text-rose-800 text-3xl font-bold">2000</p>
          <p className="text-gray-700">Loi sur la parité en politique</p>
        </div>
        <div className="bg-white bg-opacity-70 p-4 rounded-lg text-center">
          <p className="text-rose-800 text-3xl font-bold">39,5%</p>
          <p className="text-gray-700">Femmes à l'Assemblée nationale en 2022</p>
        </div>
      </div>
      
      <div className="mt-6 p-4 border-l-4 border-rose-600 bg-white bg-opacity-70 rounded-lg">
        <p className="italic">"Le chemin de l'égalité est long, mais notre détermination à le parcourir est sans faille."</p>
        <p className="text-right font-bold text-rose-800">— Simone Veil</p>
      </div>
    </div>
  </div>
);
...
const StereotypesPoster = () => (
  <div className="backdrop-blur-md bg-white bg-opacity-60 rounded-lg shadow-xl p-8 max-w-4xl">
    <div className="flex items-center mb-6">
      ...
      <h2 className="text-4xl font-bold text-amber-900">Les femmes face aux stéréotypes</h2>
    </div>
    
    <div className="mb-10">
      <h3 className="text-2xl font-bold text-amber-700 mb-4">Du statut de mineure à citoyenne</h3>
      <div className="flex flex-col md:flex-row bg-white bg-opacity-70 rounded-lg overflow-hidden">
        <div className="flex-1 p-6 border-b md:border-b-0 md:border-r border-amber-200">
          <h4 className="text-xl font-bold text-amber-800 mb-2">1804 : Code Civil Napoléonien</h4>
        ...
        <div className="flex-1 p-6">
          <h4 className="text-xl font-bold text-amber-800 mb-2">Aujourd'hui</h4>
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
    ...
    <div className="mb-10">
      <h3 className="text-2xl font-bold text-amber-700 mb-4">La lutte contre le patriarcat</h3>
      <div className="p-6 bg-white bg-opacity-70 rounded-lg mb-4">
        <h4 className="text-lg font-bold mb-2">Qu'est-ce que le patriarcat ?</h4>
        <p className="text-gray-700 mb-4">Le patriarcat est un système social, politique et économique dans lequel les hommes détiennent le pouvoir primaire et où les femmes sont largement exclues de ce pouvoir. Il se caractérise par l'autorité institutionnalisée des hommes par rapport aux femmes.</p>
        
        <div className="flex flex-col md:flex-row gap-4 mt-4">
          <div className="flex-1 bg-white bg-opacity-80 p-4 rounded border border-amber-200">
            <h5 className="font-bold text-amber-800">Mouvements féministes</h5>
          ...
          <div className="flex-1 bg-white bg-opacity-80 p-4 rounded border border-amber-200">
            <h5 className="font-bold text-amber-800">Évolutions législatives</h5>
            <ul className="list-disc pl-5 space-y-1 text-gray-700 text-sm">
    ...
    <div>
      <h3 className="text-2xl font-bold text-amber-700 mb-4">Éducation et représentation médiatique</h3>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white bg-opacity-70 p-4 rounded-lg">
          <h4 className="text-lg font-bold mb-3">Accès à l'éducation</h4>
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="w-16 h-1 bg-amber-600 mr-3"></div>
              <p><span className="font-bold">1880</span> : Loi Camille Sée créant les lycées de jeunes filles</p>
            </div>
            <div className="flex items-center">
              <div className="w-24 h-1 bg-amber-600 mr-3"></div>
              <p><span className="font-bold">1924</span> : Programmes d'enseignement identiques aux garçons</p>
            </div>
            <div className="flex items-center">
              <div className="w-32 h-1 bg-amber-600 mr-3"></div>
              <p><span className="font-bold">1975</span> : Mixité obligatoire dans tous les établissements publics</p>
            </div>
            <div className="flex items-center">
              <div className="w-40 h-1 bg-amber-600 mr-3"></div>
              <p><span className="font-bold">2013</span> : Conventions interministérielles pour l'égalité à l'école</p>
            </div>
          </div>
        </div>
        
        <div className="bg-white bg-opacity-70 p-6 rounded-lg">
          <h4 className="text-lg font-bold mb-3">Représentation dans les médias</h4>
          <p className="mb-3">Evolution de l'image des femmes dans les médias français :</p>
          <div className="space-y-2">
            <div className="flex">
              ...
              <p>De la femme au foyer idéale des années 50</p>
            </div>
            <div className="flex">
              ...
              <p>À l'objet sexuel dans la publicité des années 70-90</p>
            </div>
            <div className="flex">
              ...
              <p>Vers une représentation plus diversifiée aujourd'hui</p>
            </div>
            <div className="flex">
              ...
              <p>Initiatives contre les stéréotypes dans la communication</p>
            </div>
          </div>
        </div>
      </div>
